    ...
    <div class="d-flex align-items-center justify-content-center ht-100v">
      ...
      <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
          <div class="signin-logo tx-center tx-28 tx-bold tx-white"><span class="tx-normal">|</span>MA<span class="tx-info">SH</span> <span class="tx-normal">|</span></div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input id="email" class="form-control form-control-sm" type="email" name="email" :value="old('email')" required autofocus />
            </div>

            <!-- Password -->
            <div class="mt-4">
                <x-label for="password" :value="__('Password')" />
                <x-input id="password" class="form-control form-control-sm" type="password" name="password" required autocomplete="current-password" />
            </div>
            ...
            <div class="flex items-center justify-center mt-4">
                <x-button class=" btn btn-sm btn-info form-control from-control-sm">
                    {{ __('Log in') }}
                </x-button>  
            </div>
        </form>
