    ...
    <div class="header_top">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col col-md-6">
                    <p class="header_hotline">Call us<strong>+8801608567465</strong></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col col-lg-3 col-md-3 col-sm-12">
                    <div class="brand_logo">
                        <a class="brand_link" href="index.html">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyNXW3stvmuAID9txFOWBL_C9jcg4leMIVpJmcnySR&s" alt="">
                        </a>
                    </div>
                </div>
